        ...
        <div className="relative">
          ...
          <div className="relative h-[30rem] md:h-[32rem] overflow-hidden px-12 md:px-16 flex items-center justify-center">
            <AnimatePresence mode="wait">
              ...
              >
                <div className="h-[20rem] md:h-[22rem] border border-border bg-card shadow-[0_28px_90px_rgba(0,0,0,0.35)] backdrop-blur-md p-4 md:p-6 flex flex-col justify-between overflow-hidden">
                  <div className="space-y-4">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <span className="font-body text-xs text-foreground whitespace-nowrap">{currentReview.rating}</span>
                    </div>

                    <div className="space-y-2">
                      <p className="font-display text-3xl md:text-5xl leading-none text-white/18">"</p>
                  ...
                  <div className="pt-4 md:pt-6 space-y-2">
                    ...
                    <div className="flex gap-1 text-xs md:text-base pt-1">{renderStars(currentReview.rating)}</div>
                  </div>
                </div>
              </motion.div>
            </AnimatePresence>
